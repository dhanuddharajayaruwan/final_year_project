  ...
  return (
    <div className="font-sans text-gray-200 bg-[#121212] min-h-screen flex flex-col">
      ...
      <div className="flex-grow flex flex-col justify-center items-center px-4 relative pt-24 pb-16">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-black/90 to-transparent pointer-events-none"></div>
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-black text-white italic tracking-tighter uppercase mt-6">Welcome Back</h2>
          <p className="text-gray-400 text-sm mt-2">Log in to access your customized fitness plan.</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-5">
          ...
          <div>
            <div className="flex justify-between items-center mb-2">
              <label className="block text-xs font-bold text-gray-400 uppercase tracking-wider" htmlFor="password">Password</label>
              <Link to="/forgot-password" className="text-xs text-red-500 hover:text-red-400 transition">Forgot Password?</Link>
            </div>
            ...
            {fieldErrors.password && <p className="text-red-500 text-[10px] mt-1 font-bold uppercase tracking-widest">{fieldErrors.password}</p>}
          </div>

          <button
            type="submit"
            disabled={loading}
            className="w-full bg-red-600 text-white font-bold py-3 mt-4 rounded hover:bg-red-700 transition uppercase tracking-widest text-sm shadow-lg shadow-red-600/30 disabled:opacity-50 disabled:cursor-not-allowed"
          >
        ...
        <p className="text-gray-500 text-sm text-center mt-8">
          ...
          <Link to="/register" className="text-red-500 hover:text-red-400 transition font-bold">
            Sign Up
          </Link>
        </p>
      </div>
